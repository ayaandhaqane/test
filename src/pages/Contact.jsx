...
function Contact() {
  return (
    <div>
      ...
      <section className="bg-gradient-to-b from-[#101212] to-[#08201D] min-h-screen flex items-center justify-center">
        <div className="container px-6 py-3 mx-auto  rounded-2xl">
          <div className="lg:flex lg:items-center lg:-mx-6">
            <div className="lg:w-1/3 lg:mx-6">
              <h1 className="text-2xl font-semibold text-white capitalize text-white lg:text-3xl">
              ...
              <div className="mt-6 space-y-8 md:mt-8">
                <p className="flex items-start -mx-2">
                  ...
                  <span className="mx-2 text-white truncate w-72 text-white">
                    Mugadisho
                    St.Hodan
                  </span>
                </p>
                <p className="flex items-start -mx-2">
                  ...
                  <span className="mx-2 truncate w-72 text-white">(252) 615-107933</span>
                </p>
                <p className="flex items-start -mx-2">
                  <svg xmlns="http://www.w3.org/2000/svg" className="w-6 h-6 mx-2 text-blue-500 dark:text-blue-400" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2">
                    <path strokeLinecap="round" strokeLinejoin="round" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                  </svg>
                  <span className="mx-2 text-gray-700 truncate w-72 text-white">acb@example.com</span>
                </p>
              </div>

              <div className="mt-6 w-80 md:mt-8">
                <h3 className="text-gray-600 text-white">Follow us</h3>
            ...
            <div className="mt-8 lg:w-1/2 lg:mx-6">
              <div
                className="w-full px-8 py-10 mx-auto overflow-hidden bg-white rounded-lg shadow-2xl dark:bg-blue-950 lg:max-w-xl shadow-red-300/50 ">
                <h1 className="text-lg font-medium text-white">What do you want to ask</h1>

                <form className="mt-6">
                  <div className="flex-1">
                    <label className="block mb-2 text-sm text-gray-600 dark:text-gray-200">Full Name</label>
                    <input type="text" placeholder="your name" className="block w-full px-5 py-3 mt-2 text-gray-700 placeholder-gray-400 bg-white border border-gray-200 rounded-md dark:placeholder-gray-600 dark:bg-blue-950 dark:text-gray-300 dark:border-gray-700 focus:border-blue-400 dark:focus:border-blue-400 focus:ring-blue-400 focus:outline-none focus:ring focus:ring-opacity-40" />
                  </div>
